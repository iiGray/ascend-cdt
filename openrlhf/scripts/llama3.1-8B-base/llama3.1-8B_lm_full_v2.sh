...
deepspeed --master_port 29506 --include localhost:0,1,2,3,4,5,6,7 cli/context_denoise/language_modeling.py \
   ...
   --save_path ${SAVE_DIR}/pg19/Llama-3.1-8B/opposite_gradient_large_pos-1e-3-v2 \
   --ckpt_path ${SAVE_DIR}/pg19/Llama-3.1-8B/opposite_gradient_large_pos-1e-3-v2 \
   --save_steps 50 \
   --logging_steps 1 \
   --eval_steps 50 \
   ...
   --wandb_project '二代机' \
   --wandb_run_name 'Llama-3.1-8B-opposite_gradient_large_pos-1e-3-v2' \
   --ring_attn_size 4 \
   --ring_head_stride 2;