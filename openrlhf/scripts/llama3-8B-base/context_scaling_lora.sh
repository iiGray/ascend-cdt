...
deepspeed --master_port 29500 --include localhost:0,1,2,3,4,5,6,7 cli/context_denoise/context_scaling.py \
   ...
   --save_path ${SAVE_DIR}/pg19/Llama-3-8B-Scaling-Noise/lora \
   --ckpt_path ${SAVE_DIR}/pg19/Llama-3-8B-Scaling-Noise/lora  \
   --save_steps 50 \
   --lora_rank 32 \
   --logging_steps 1 \
   --eval_steps 25 \
   ...
   --wandb_run_name 'Llama-3-8B-Base-lora_32-embedding-epsilon_lr' \
   --ring_attn_size 4 \
   --ring_head_stride 2;