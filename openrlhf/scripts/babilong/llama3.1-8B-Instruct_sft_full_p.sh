...
deepspeed --include localhost:0,1,2,3,4,5,6,7 cli/train_babilong.py \
   ...
   --save_path ${SAVE_DIR}/babilong/Llama-3.1-8B-Instruct/sft_full_dev \
   --ckpt_path ${SAVE_DIR}/babilong/Llama-3.1-8B-Instruct/sft_full_dev \
   --save_steps 100 \
   --logging_steps 1 \
   --eval_steps 50 \
   --zero_stage 2 \
   ...
   --wandb_run_name 'Llama-3.1-8B-babilong-sft_full_dev' \
   --ring_attn_size 4;