...
deepspeed --module train_cdt \
   ...
   --pretrain ${MODEL_PATH} \
   --save_dir ${SAVE_DIR} \
   --save_path ${SAVE_DIR}/model/pg19/deepseek-v2-lite/opposite_gradient_large_pos_2e-6_1e-2 \
   --ckpt_path ${SAVE_DIR}/ckpt/pg19/deepseek-v2-lite/opposite_gradient_large_pos_2e-6_1e-2 \
   --save_steps 50 \
   --logging_steps 1 \
   --eval_steps 50 \
   ...
   --wandb_run_name 'deepseek-v2-lite_opposite_gradient_large_pos_2e-6_1e-2' \
