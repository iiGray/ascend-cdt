...
deepspeed --module train_cdt \
   ...
   --pretrain ${MODEL_PATH} \
   --save_dir ${SAVE_DIR} \
   --save_path ${SAVE_DIR}/model/pg19/deepseek-v2-lite/ebd_opposite_gradient_large_pos-1e-3-v2 \
   --ckpt_path ${SAVE_DIR}/ckpt/pg19/deepseek-v2-lite/ebd_opposite_gradient_large_pos-1e-3-v2 \
   --save_steps 50 \
   --logging_steps 1 \
   --eval_steps 50 \
   ...
   --wandb_run_name 'deepseek-v2-lite-ebd_opposite_gradient_large_pos-1e-3-v2' \
