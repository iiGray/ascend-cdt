...
from openrlhf.datasets.context_denoise.sft_dataset import SFTDataset
...
def train(args):
    ...
    if args.huggingface_key is not None:
        dataset = load_dataset(args.dataset, token=args.huggingface_key)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--adv_epsilon", type=float, default=None)
    parser.add_argument("--perturb_type", type=str, default="loss")
    parser.add_argument("--loss_weight", type=float, default=1.0)
    parser.add_argument("--huggingface_key", type=str, default=None)
